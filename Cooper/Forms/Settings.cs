...
namespace Cooper.Forms
{
    public partial class Settings : Form
    {
        ...
        {
            RegistryKey key = Registry.ClassesRoot.OpenSubKey("CooperGemini");
            string appPath = Environment.GetCommandLineArgs()[0];

            if (key == null)
            {
                key = Registry.ClassesRoot.CreateSubKey("CooperGemini");
            }
        ...
        {
            Registry.ClassesRoot.DeleteSubKeyTree("CooperGemini");
        }
    }
}
